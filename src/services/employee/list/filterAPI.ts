...
export const FILTER_OPTIONS = {
    class: ["Service Delivery", "SZ Team", "Business Solutions and Innovation"],
    type: [
        "Probationary",
        "Regular",
        "Contractual",
            ...
            queryFn: async () => {
                ...
                const mockData: FilterOptions = {
                    ...
                    position_types: [
                        {
                            position_type_ID:
                                "cbdae27c515d11f0b6b802dcb324866b",
                            type_name: "full-time",
                        },
                        {
                            position_type_ID:
                                "cbdb0665515d11f0b6b802dcb324866b",
                            type_name: "part-time",
                        },
                        {
                            position_type_ID:
                                "cbdb07c0515d11f0b6b802dcb324866b",
                            type_name: "contract",
                        },
                        {
                            position_type_ID:
                                "cbdb0827515d11f0b6b802dcb324866b",
                            type_name: "freelance",
                        },
                    ],
                };
