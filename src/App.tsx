            ...
            <Routes>
                <Route path="/home/*" element={<Home />}>
                    ...
                    <Route path="settings/*" element={<Settings />}>
                        ...
                        <Route path="tags/archived-tags" element={<Tags mode="archived" />} />
                        <Route path="positions" element={<Positions mode="all-positions" />} />
                        <Route path="positions/archived-positions" element={<Positions mode="archived" />} />
                    ...
                    <Route path="security-settings/*" element={<SecuritySettings />}>
                        <Route path="security-configuration" element={<SecurityConfiguration />} />
                        <Route path="2-factor-authentication" element={<TwoFactorAuthentication />} />
                        <Route path="active-session-management" element={<ActiveSessionManagement />} />
