...
import { Diagram, Element3, Notification, People, ProgrammingArrows, SecuritySafe, Setting2, User } from "iconsax-reactjs";
...
const Home = () => {
    ...
    const menu = [
        ...
        {
            id: "8",
            icon: <SecuritySafe variant="Bulk" className={selected === "8" ? "text-szPrimary100" : "text-szPrimary500"} />,
