  ...
  const menu = [
    {
      ...
      icon: (
        <Element3
          variant="Bulk"
          className={
            selected === "1" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
      label: "Dashboard",
    ...
    },
    {
      ...
      icon: (
        <User
          variant="Bulk"
          className={
            selected === "2" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
      label: "Employees",
    ...
    },
    {
      ...
      icon: (
        <People
          variant="Bulk"
          className={
            selected === "3" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
      label: "Teams",
    ...
    },
    {
      ...
      icon: (
        <Notification
          variant="Bulk"
          className={
            selected === "4" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
      label: "Notifications",
    ...
    },
    {
      ...
      icon: (
        <Diagram
          variant="Bulk"
          className={
            selected === "5" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <ProgrammingArrows
          variant="Bulk"
          className={
            selected === "6" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <Setting2
          variant="Bulk"
          className={
            selected === "7" ? "text-szPrimary100" : "text-szPrimary500"
          }
        />
      ),
      label: "Settings",
