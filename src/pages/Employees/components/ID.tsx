...
import { Table, HeaderType, Avatar, ButtonsIcon, SnackbarAlert } from "enterprisze-global-components";
import { Add } from "iconsax-react";
import IDModal from "./modals/IDModal";
const employeeIDheaders: HeaderType[] = [{ type: "string", header: "Employee ID", accessor: "employeeId" }];
const employeeID = [
    {
        employeeId: "220375",
    },
...
const IDdata = [
    {
        ...
        addedBy: (
            <>
                <Avatar size="xsmall" src="https://i.pravatar.cc/100?img=32" showBadge={true} />
        ...
        <div className="grid grid-cols-1 gap-[28px]">
            ...
            <div className="flex flex-col w-full gap-[8px]">
                <div className="flex justify-between">
                    ...
                    <ButtonsIcon icon={<Add variant="Linear" />} variant="secondary" size="small" onClick={() => setIsModalOpen(true)} />
                </div>
                <Table headers={headers} data={IDdata} />
            </div>
            {/* Modal component */}
            <IDModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} IDdata={IDdata} onSubmitSuccess={handleSubmitSuccess} />
