...
const FamilyModal: React.FC<FamilyModalProps> = ({
  ...
  const [currentFamilyData, setCurrentFamilyData] =
    useState<FamilyMemberDataType | null>(null);
                      ...
                      children={
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start">
                          ...
                          <div className="break-all">
                            <TextContent
                              header="middle name"
                              text={familyMember.middleName}
                            />
                          </div>
                          <div className="break-all">
                            <TextContent
                              header="extensions"
                              text={familyMember.extension}
                            />
                          </div>
                          <div className="break-all">
                            <TextContent
                              header="contact number"
                              text={familyMember.contactNumber}
                            />
                          </div>
                          <div className="break-all">
                            <TextContent
