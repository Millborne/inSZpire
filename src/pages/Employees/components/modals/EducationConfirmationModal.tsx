...
// components
import EducationalPendingModal from "./EducationalPendingModal";
...
const EducationConfirmationModal: React.FC<EducationConfirmationModalProps> = ({
  ...
  const [isEducationalPendingModalOpen, setIsEducationalPendingModalOpen] =
    useState(false);

  const handlePendingCheck = () => {
    setIsEducationalPendingModalOpen(true);
  };
  ...
  return (
    <>
      ...
      />
      <EducationalPendingModal
        isOpen={isEducationalPendingModalOpen}
        onClose={() => setIsEducationalPendingModalOpen(false)}
