...
interface BasicInfoPendingModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const BasicInfoPendingModal: React.FC<BasicInfoPendingModalProps> = ({ isOpen, onClose, onCloseConfirmation, onSubmitSuccess }) => {
                    ...
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <div className="flex flex-col gap-[8px]">
                            <PendingRequestContent
                                variant="add"
                                title={pendingBasicInfoMember.title}
                                previous={pendingBasicInfoMember.previous}
                                current={pendingBasicInfoMember.current}
                                onSelect={(type, data) => {
...
export default BasicInfoPendingModal;
