    ...
    const handleUpdateEmployee = async () => {
        try {
            if (employeeData) {
                ...
                await updateEmployee(transformedData).unwrap();
                if (onSubmitSuccess) {
                    onSubmitSuccess();
                }
            }
            ...
            content={
                <div className="flex flex-col gap-[16px]">
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <div className="flex flex-col gap-[16px]">
                            <ConfirmationContent variant="edit" sectionLabel="NAME AND BIRTHDAY" data={nameAndBirthdayData} />
                            <ConfirmationContent variant="edit" sectionLabel="WORK" data={workData} />
                            <ConfirmationContent variant="edit" sectionLabel="ADDRESS" data={addressData} />
                            <ConfirmationContent variant="edit" sectionLabel="OTHERS" data={otherData} />
                        </div>
                    </div>
                </div>
            }
