...
import { CardContainer, PopoverMenu, Inputs, ButtonsIcon, Tab, Pagination, Tabs, SnackbarAlert } from "enterprisze-global-components";
import { Add, ExportCurve, Filter, Firstline, Grid2, SearchNormal } from "iconsax-reactjs";
                ...
                content={
                    <div className="flex flex-col gap-[20px] h-full">
                        ...
                        <section className="flex flex-wrap justify-end sm:justify-between gap-[12px]  items-center w-full ">
                            ...
                            <ButtonsIcon icon={<Filter />} size="medium" variant="ghost" onClick={() => {}} />
                        </section>
                        <TeamsList
