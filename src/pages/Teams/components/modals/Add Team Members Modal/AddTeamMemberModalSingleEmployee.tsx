          ...
          <div className="flex flex-col gap-2 mt-1">
            <div className="w-full">
              <span className="text-body-small-strong text-szDarkGrey600">
                You can only add new member to the team if there are available
                positions.
              </span>
            </div>
              ...
              employee.saved ? (
                  ...
                  <div className="w-full border border-error700 rounded-lg p-2 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-body-small-strong">
                        Are you sure you want to cancel adding Rigor, John
                        Daryll?
                      </span>
                    </div>
                ...
                <div className="w-full border border-szGrey300 rounded-lg p-2 flex flex-col gap-2">
                  <span className="text-caption-strong text-[#1D973C]">
                    Assigning Employee to available Position from Business
                    Solution & Innovation
                  </span>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center gap-5">
                <div className="flex-1">
                  <TextContent header="Employee Name" text="John Doe" />
                </div>
                ...
                <div className="flex-1">
                  <TextContent header="Position" text="Junior Web Developer" />
                </div>
              </div>
