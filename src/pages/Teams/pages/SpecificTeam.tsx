...
import AddTeamMemberModalSingleEmployee from "../components/modals/Add Team Members Modal/AddTeamMemberModalSingleEmployee";
      ...
      <CardContainer
        content={
          <div className="flex flex-col gap-[20px]">
            <div className="flex flex-1 items-start gap-[8px] flex-wrap">
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div>
                <div className="flex flex-col lg:flex-row justify-between">
                  ...
                  <div className="flex flex-col gap-[8px] items-start my-[16px] sm:mx-0">
