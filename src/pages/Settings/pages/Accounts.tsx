...
const Accounts: React.FC<AccountsPageProps> = ({ mode }) => {
    ...
    const [accountToArchive, setAccountToArchive] = useState<AccountDataType | null>(null);
            ...
            <CardContainer
                content={
                    <div className="grid grid-cols-1 gap-[20px]">
                                            ...
                                            items={[
                                                {
                                                    label: "Add Account",
                                                    icon: <Add />,
                                                    onClick: () => handleOpenModal({} as AccountDataType, "add"),
                                                },
                                                {
                        ...
                        <Table headers={headers} data={coloredData} moreOptions={moreOptions} />
