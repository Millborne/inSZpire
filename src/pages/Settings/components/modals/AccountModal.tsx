...
import { ConfirmationContent, Dropdown, Inputs, Modal, Toggle } from "enterprisze-global-components";
...
const AccountModal: React.FC<AccountModalProps> = ({ isOpen, onClose, mode, selectedAccount, onSave }) => {
    // Form state
